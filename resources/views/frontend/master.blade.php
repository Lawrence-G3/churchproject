                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-md-3 col-sm-6">
                            <div class="news">
                                <img class="news-image" src="images/news-thumb-1.jpg" alt="">
                                <h3 class="news-title"><a href="#">kesha</a></h3>
                                <small class="date"><i class="fa fa-calendar"></i>27 july 2024</small>
                            </div>
                        </div>
                        <div class="col-md-3 col-sm-6">
                            <div class="news">
                                <img class="news-image" src="images/news-thumb-2.jpg" alt="">
                                <h3 class="news-title"><a href="#">practice</a></h3>
                                <small class="date"><i class="fa fa-calendar"></i>24 mar 2024</small>
                            </div>
                        </div>
                        <div class="col-md-3 col-sm-6">
                            <div class="news">
                                <img class="news-image" src="images/news-thumb-3.jpg" alt="">
                                <h3 class="news-title"><a href="#">meetings</a></h3>
                                <small class="date"><i class="fa fa-calendar"></i>4 aug 2024</small>
                            </div>
                        </div>
                        <div class="col-md-3 col-sm-6">
                            <div class="news">
                                <img class="news-image" src="images/news-thumb-4.jpg" alt="">
                                <h3 class="news-title"><a href="#">sharing</a></h3>
                                <small class="date"><i class="fa fa-calendar"></i>24 aug 2024</small>
                            </div>
                        </div>
                    </div> <!-- .row -->
                </div> <!-- .container -->
                                ...
                                <li>
                                    <a href="#">
                                        ...
                                        <span class="event-meta">
                                            <span><i class="fa fa-calendar"></i>30 mar 2024</span>
                                ...
                                <li>
                                    <a href="#">
                                        ...
                                        <span class="event-meta">
                                            ...
                                            <span><i class="fa fa-map-marker"></i> Jesus Worship and restoration Center</span>
                                        </span>
                                    </a>
                                </li>
                                <li>
                            ...
                            <ul class="sermon-list">
                                <li>
                                    ...
                                    <div class="sermon-detail">
                                        <h3 class="sermon-title"><a href="#">I believe in god with all my heart</a></h3>
                                ...
                                <li>
                                    ...
                                    <div class="sermon-detail">
                                        <h3 class="sermon-title"><a href="#">I love god with all my heart</a></h3>
                                        <div class="sermon-meta">
                                            <div class="pastor"><i class="fa fa-user"></i> anthony clark</div>
                                            <div class="date"><i class="fa fa-calendar"></i> 18 mar 2014</div>
                                        </div>
                                    </div>
                                </li>
                                <li>
                                    ...
                                    <div class="sermon-detail">
                                        <h3 class="sermon-title"><a href="#">Love your kids</a></h3>
                                        <div class="sermon-meta">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="widget">
                            ...
                            <p>Lorem ipsum  pain sits, with circumstances suitable, but do because of time conditions occur to work and sorrow big however. Ways of insight great, from itself laborious time holds, something rejects, from with said things rejecting we accuse. All things rejected as if softness, just hate worthiness.</p>
                            <ul class="address">
